...
class AbstractCallbackTokenInline(admin.StackedInline):
    ...
    fields = ('created_at', 'key', 'type', 'is_active')
...
class AbstractCallbackTokenAdmin(admin.ModelAdmin):
    readonly_fields = ('created_at', 'key', 'type', 'to_alias_type')
    list_display = ('created_at', 'key', 'type', 'is_active', 'to_alias_type')
    fields = ('created_at', 'key', 'type', 'is_active', 'to_alias_type')
    extra = 0
